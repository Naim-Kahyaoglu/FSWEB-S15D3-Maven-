...
public class WordCounter {
    ...
    public static Map<String, Integer> calculatedWord() {
        ...
        // Normalize the text: convert to lowercase and split by spaces and punctuation, but retain apostrophes and hyphens
        String[] words = text.toLowerCase()
                .replaceAll("[^a-zA-Z\\s'-]", "") // Keep apostrophes and hyphens
                .split("\\s+");
        ...
        // DEBUG: Print the entire map to see which words are counted
